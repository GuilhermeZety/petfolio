...
class RequestResult extends Equatable {
  ...
  factory RequestResult.fromJson(String source) =>
      RequestResult.fromMap(json.decode(source) as Map<String, dynamic>);
  ...
  List<Object?> get props {
    return [statusCode, data, headers, success, message];
  }
}
