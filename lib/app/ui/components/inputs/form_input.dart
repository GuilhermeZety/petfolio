    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          style: TextStyle(color: context.textTheme.titleLarge?.color, fontSize: 16),
            ...
            prefixIcon:
                widget.prefixIcon != null
                    ? Container(
                      ...
                      decoration: const BoxDecoration(border: Border(right: BorderSide(color: AppColors.grey_100, width: 2))),
                      alignment: Alignment.center,
                      child: Icon(widget.prefixIcon, color: AppColors.grey_500),
                    )
                    : null,
          ),
        ),
